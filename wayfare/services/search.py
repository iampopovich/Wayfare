...
class SearchService:
    ...
    def _prepare_engine_kwargs(self, engine: str, filters: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    ...
    def _extract_price_information(self, results: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
